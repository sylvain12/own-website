...
<div class="social-wrapper">
  <a href={$owner.social.github} target="_blank">
...
<a href={$owner.social.linkedin} target="_blank">
<svg class="w-4rem] h-[4rem]" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<a href={$owner.social.dribbble} target="_blank">
<svg class="w-4rem] h-[4rem]" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<a href={$owner.social.instagram} target="_blank">
<svg class="w-4rem] h-[4rem]" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
